...
public class Menu extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    btnRoundRobin.addActionListener(
    ...
    btnPrioridad.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void btnRoundRobinActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnRoundRobinActionPerformed
  ...
  private void btnSJFActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnSJFActionPerformed
  ...
  private void btnFIFOActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnFIFOActionPerformed
  ...
  private void btnPrioridadActionPerformed(
      java.awt.event.ActionEvent evt) { // GEN-FIRST:event_btnPrioridadActionPerformed
