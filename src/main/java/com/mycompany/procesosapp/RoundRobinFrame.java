...
public class RoundRobinFrame extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    btnAgregarProceso.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    tblProcesos.setModel(
        new javax.swing.table.DefaultTableModel(
            new Object[][] {{null, null}}, new String[] {"Nombre Proceso", "Tiempo Proceso"}));
    jScrollPane1.setViewportView(tblProcesos);

    btnStartRR.setText("Iniciar RR");
    btnStartRR.addActionListener(
        new java.awt.event.ActionListener() {
          public void actionPerformed(java.awt.event.ActionEvent evt) {
  ...
  private void btnStartRRActionPerformed(
    ...
    while (rrListProcesos.size() > 0) {
      ...
      while (iterador.hasNext()) {
        ...
        if (currentProcessString.equals(lastProcessString)
            && iterations == 0
            && proceso.getTime() < quantum) {
          TE += 0;
        ...
        } else if (currentProcessString.equals(lastProcessString)
            && iterations == 0
            && proceso.getTime() >= quantum) {
          TE += 0;
          lastTE = quantum;
